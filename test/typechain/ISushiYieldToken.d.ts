...
interface ISushiYieldTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class ISushiYieldToken extends BaseContract {
  ...
  interface: ISushiYieldTokenInterface;
