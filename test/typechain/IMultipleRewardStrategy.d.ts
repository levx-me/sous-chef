...
interface IMultipleRewardStrategyInterface extends ethers.utils.Interface {
  functions: {
...
export class IMultipleRewardStrategy extends BaseContract {
  ...
  interface: IMultipleRewardStrategyInterface;
